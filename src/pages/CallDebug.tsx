...
const CallDebug: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-surface-primary">
      {/* Header */}
      <div className="border-b border-border bg-surface-secondary/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-text-primary">Call Debug</h1>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {/* Event Breakdown */}
        <Card className="mb-8 neural-glow">
          <CardHeader>
