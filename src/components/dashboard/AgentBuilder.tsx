...
import { Bot, Settings, Globe, Volume2, Brain, Wrench, FileText, Shield, TestTube, Save, Play, Plus, Trash2, Edit, ArrowLeft, Upload, Download, Mic, MicOff, HelpCircle, Sparkles, Eye } from "lucide-react";
...
export function AgentBuilder({
  ...
  const providers = [{
    ...
    models: [{
      ...
      cost: "$0.03",
      latency: "380ms",
      markers: ["Standard", "Conversational"]
    }, {
      id: "gpt-4",
      name: "GPT-4",
      cost: "$0.06",
      latency: "450ms",
      markers: ["Premium", "Multimodal"]
    }, {
      id: "gpt-3.5-turbo",
      name: "GPT-3.5 Turbo",
      cost: "$0.001",
      latency: "280ms",
      markers: ["Cheapest", "Fastest"]
    }]
  }, {
    id: "Groq",
    name: "Groq",
    models: [{
      ...
      cost: "$0.02",
      latency: "120ms",
      markers: ["Fastest", "Open Source"]
    }, {
      id: "mixtral-8x7b",
      name: "Mixtral 8x7B",
      cost: "$0.015",
      latency: "150ms",
      markers: ["Fast", "Efficient"]
    }]
  }, {
    id: "Anthropic",
    name: "Anthropic",
    models: [{
      ...
      cost: "$0.015",
      latency: "320ms",
      markers: ["Balanced", "Reasoning"]
    }, {
      id: "claude-3-haiku",
      name: "Claude 3 Haiku",
      cost: "$0.008",
      latency: "250ms",
      markers: ["Fast", "Concise"]
    }]
  }];
  const templates = [{
    id: "lead-collection",
  ...
  const tools = [{
    ...
    enabled: false,
    description: "Book calendar appointments"
  }, {
    id: "api",
    name: "API Request",
    enabled: true,
    description: "Custom webhook calls"
  }];
  ...
  return <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          {onBack && <Button variant="ghost" size="icon" onClick={onBack} className="text-text-muted hover:text-text-primary hover:bg-surface-2">
      ...
      <Tabs defaultValue="persona" className="space-y-6">
        ...
        <TabsContent value="persona" className="space-y-6">
            ...
            <Card className="bg-gradient-card border-border/50 shadow-card">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="agent-name" value={agentName} onChange={e => setAgentName(e.target.value)} placeholder="e.g., Aarav" />
                </div>
                <div className="space-y-2">
          ...
          <Card className="bg-gradient-card border-border/50 shadow-card">
            ...
            <CardContent>
              <Textarea placeholder="Enter your agent's system prompt and instructions..." className="min-h-[200px]" defaultValue="You are Sarah, a professional lead qualification agent for a SaaS company. Your goal is to identify qualified prospects by understanding their budget, authority, need, and timeline. Be conversational, helpful, and respectful. Always ask for permission before asking qualifying questions." />
            </CardContent>
          </Card>
        </TabsContent>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["en-US", "hi-IN", "en-IN"].map(lang => <Badge key={lang} variant={selectedLanguages.includes(lang) ? "default" : "outline"} className="cursor-pointer">
                        {lang}
                      </Badge>)}
                  </div>
                </div>
        ...
        <TabsContent value="tools" className="space-y-6">
          <Card className="bg-gradient-card border-border/50 shadow-card">
            ...
            <CardContent>
              <div className="space-y-4">
                {tools.map(tool => <div key={tool.id} className="flex items-center justify-between p-4 bg-accent/30 rounded-lg">
        ...
        <TabsContent value="knowledge" className="space-y-6">
          <Card className="bg-gradient-card border-border/50 shadow-card">
            ...
            <CardContent>
              <div className="space-y-4">
                {knowledgePacks.map(pack => <div key={pack.id} className="flex items-center justify-between p-4 bg-accent/30 rounded-lg">
                    <div className="flex items-center space-x-4">
                      <div className="flex items-center space-x-2">
                    ...
                    <div className="flex items-center space-x-3">
                      <Badge variant={pack.status === "HOT" ? "default" : pack.status === "WARMING" ? "secondary" : "outline"} className={pack.status === "HOT" ? "bg-success/20 text-success" : pack.status === "WARMING" ? "bg-warning/20 text-warning" : "bg-muted/20 text-muted-foreground"}>
                        {pack.status}
                      </Badge>
                  ...
                  <CardContent>
                    <div className="border rounded-lg">
                      ...
                      <div className="divide-y">
                        ...
                        locale: "en-US",
                        status: "active"
                      }].map(entry => <div key={entry.id} className="grid grid-cols-6 gap-4 p-4 items-center">
                  ...
                  <CardContent>
                    <div className="border rounded-lg">
                      ...
                      <div className="divide-y">
                        ...
                        weight: 1.2,
                        locale: "en-US"
                      }].map(phrase => <div key={phrase.id} className="grid grid-cols-4 gap-4 p-4 items-center">
                ...
                <Card className="bg-gradient-card border-border/50 shadow-card">
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Textarea id="bulk-phrases" className="min-h-[120px]" placeholder={`budget range
decision maker
            ...
            <Card className="bg-gradient-card border-border/50 shadow-card">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea placeholder="Enter TCPA disclosure message..." defaultValue="This call may be recorded for quality and training purposes. By continuing, you consent to receive future calls from us." className="h-20" />
                </div>
                <div className="space-y-2">
                  <Label>Opt-out Phrases</Label>
                  <div className="flex flex-wrap gap-2">
                    {["stop calling", "remove me", "do not call", "unsubscribe"].map(phrase => <Badge key={phrase} variant="outline" className="cursor-pointer">
                        {phrase}
                      </Badge>)}
                  </div>
                </div>
            ...
            <Card className="bg-gradient-card border-border/50 shadow-card">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea placeholder="Enter TRAI disclosure message in Hindi..." defaultValue="यह कॉल गुणवत्ता और प्रशिक्षण उद्देश्यों के लिए रिकॉर्ड किया जा सकता है।" className="h-20" />
                </div>
                <div className="space-y-2">
